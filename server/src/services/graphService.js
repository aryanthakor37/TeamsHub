...
const fetchGraphChatsFromAPI = async (accessToken) => {
  ...
  // Personal Consumer Account Starter Feed Fallback if Microsoft Graph returns 0 chats for Consumer MSA
  if (items.length === 0) {
    try {
          ...
          value: [
            {
              ...
              lastMessagePreview: {
                ...
                body: { contentType: 'text', content: 'real account connect thay che ?' },
